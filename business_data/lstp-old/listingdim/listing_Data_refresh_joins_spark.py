...
def main():
    ...
    df_property_dim_All = read_parquet_and_create_dataframe_table('s3://move-dataeng-lstp-dev/edw/post-pdt/propertydim/propertydim-bd-full', 'edw_properties_deduped')

    df_listing_dim_All = read_parquet_and_create_dataframe_table('s3://move-dataeng-lstp-prod/edw/processed-data-xact/listing_dim/year=2017/month=12/day=16/hour=01','listing_dim_All')
    ...
    sql_text = getStringFromFile('move-dataeng-lstp-dev', 'edw/propertydim_temp_scripts/listing_dim_dedupe_bd_addtn_joins.sql')
    print sql_text
