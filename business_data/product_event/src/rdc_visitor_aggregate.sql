...
,a.post_visid_high || '-' || a.post_visid_low 
,a.post_visid_high || '-' || a.post_visid_low||'-'||a.visit_num  
,lower(trim(a.post_evar17 ))  
, (case when
lower(trim(post_evar17))='rdc-responsive'
Then 'Web'
Else
...
Else 'Others'
END)  
,lower(trim(a.post_prop32)) 
,lower(trim(a.post_prop40))  
,(case when
lower(trim(a.post_prop40)) in ('ldp','ldp-quickview','ldp-seller-summary')
Then 'LDP'
Else
...
END)
END)  
,lower(trim(a.post_prop67))  
,lower(trim(a.post_channel))  
,lower(trim(a.post_pagename)) 
,lower(trim(a.post_mobileappid))  
,lower(trim(a.post_mobileosversion))  
,lower(trim(a.va_closer_id))  
,(case when lower(trim(a.va_closer_id)) = '1' then 'Move Inc Sites'
when lower(trim(a.va_closer_id)) = '2' then 'Paid Search'
when lower(trim(a.va_closer_id)) = '3' then 'Organic Search'
when lower(trim(a.va_closer_id)) = '4' then 'Display'
...
END) 
,lower(trim(a.va_closer_detail))  
,lower(trim(a.mobile_id))  
,lower(trim(a.user_agent))  
,lower(trim(a.os)) 
,lower(trim(a.hit_source))  
,lower(trim(a.post_page_event)) 
