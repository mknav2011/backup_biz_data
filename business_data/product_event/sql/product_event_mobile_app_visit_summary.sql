...
, sum(case when site_section = 'for sale'  then 1 else 0 end) fs_pageview_count
, sum(case when site_section = 'for rent'  then 1 else 0 end) fr_pageview_count
, sum(case when site_section = 'not for sale' then 1 else 0 end) nfs_pageview_count
, sum(case when site_section = 'others' then 1 else 0 end) others_pageview_count
from biz_data.product_event_mapi_biz_data
...
, (case when site_section = 'for sale'  then 1 else 0 end)
, (case when site_section = 'for rent'  then 1 else 0 end)
, (case when site_section = 'not for sale' then 1 else 0 end)
, (case when site_section = 'others' then 1 else 0 end) 
