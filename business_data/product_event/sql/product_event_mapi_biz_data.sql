...
,lower(trim(params__querystring__src)) device_type
...
,b.eventtypegroup as event_type_group
...
left outer join movedm.edw_tbleventtypedim b
on( a.params__querystring__ptnid = cast(b.eventtypeid as varchar) )
WHERE  1=1
AND year = '{year}'
AND month = '{month}'
AND day = '{day}'
