CREATE EXTERNAL TABLE `properties_history`(
...
LOCATION
  's3://move-dataeng-lstp-dev/edw/business-data/propertydim/propertydim-glue/bucket=historical'
TBLPROPERTIES (
  'PARQUET.COMPRESS'='SNAPPY',
  'transient_lastDdlTime'='1516872932')