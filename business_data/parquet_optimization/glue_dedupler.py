...
glueContext.write_dynamic_frame.from_options(frame = new_dynamic_frame, connection_type = "s3", connection_options = {"path":  output_folder}, format = "parquet", compression=codec)
