...
, sum(case when site_section = 'news and insights' and post_page_event ='0' then 1 else 0 end) newsinsights_pageview_count
...
from biz_data_product_event.rdc_biz_data
