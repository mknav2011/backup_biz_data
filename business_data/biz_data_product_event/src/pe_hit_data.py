...
def main():
    ...
    parser.add_argument('--input_date',  help='(Optional) input_date to run job for a specific date, Date Input in YYYYMMDD format ')
    ...
    #    input_date_list =  generate_hourly_partitions(input_date+ ' 00', '')
    #else:
    #    input_date_list = [input_date+ ' 00'] # '2018-01-19 00' 
    input_tuple_list = [] 
